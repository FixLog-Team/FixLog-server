...
public class WorkspaceController {
    ...
    @Operation(operationId = "renameWorkspace")
    ...
    @Operation(operationId = "listWorkspaceMembers")
    ...
    @Operation(operationId = "inviteWorkspaceMember")
    ...
    @Operation(operationId = "changeWorkspaceMemberRole")
    ...
    @Operation(operationId = "removeWorkspaceMember")
    ...
    @Operation(operationId = "leaveWorkspace")
