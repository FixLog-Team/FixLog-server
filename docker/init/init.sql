...
COMMENT ON TABLE apj_code_group IS '공통 코드 그룹';
...
COMMENT ON TABLE apj_code IS '공통 코드 상세';
...
COMMENT ON TABLE apj_file IS '문서 첨부 및 일반 파일 관리';
...
COMMENT ON TABLE apj_workspace IS '워크스페이스(드라이브) 정보';
...
COMMENT ON TABLE apj_workspace_role IS '워크스페이스 내부 전용 권한 정의';
...
COMMENT ON TABLE apj_workspace_user IS '워크스페이스 소속 사용자 정보';

-- -----------------------------------------------
-- 기초 데이터 (seed data)
-- -----------------------------------------------

INSERT INTO apj_code_group (code_group, code_group_type, code_group_desc, ordinal, usable, create_user, create_time, create_ip, update_user, update_time, update_ip) VALUES
...
INSERT INTO apj_code (code, code_group, code_desc, code_option1, code_option2, code_option3, ordinal, usable, create_user, create_time, create_ip, update_user, update_time, update_ip) VALUES
...
INSERT INTO apj_role (role_id, role_status, role_desc, ordinal, usable, create_user, create_time, create_ip, update_user, update_time, update_ip) VALUES
...
INSERT INTO apj_workspace_role (role_id, role_status, role_desc, ordinal, usable, create_user, create_time, update_user, update_time) VALUES
